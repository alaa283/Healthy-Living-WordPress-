...
<div class="page-hero bg-image overlay-dark" style="background-image: url(<?php echo get_template_directory_uri(); ?>/img/bg_image_1.jpg);">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
            <div class="img-place custom-img-1">
              <img src="<?php echo get_template_directory_uri(); ?>/img/bg-doctor.png" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="card-blog">
            <div class="header">
              ...
              <a href="<?php echo get_permalink(); ?>" class="post-thumb">
                <!-- <img src="<?php //echo get_template_directory_uri(); ?>/img/blog/blog_1.jpg" alt=""> -->
